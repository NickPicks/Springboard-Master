...
SELECT name, monthlymaintenance
	CASE WHEN monthlymaintenance > 100 THEN 'expensive' WHEN monthlymaintenance >= 100 THEN 'cheap' END AS price
FROM Facilities
...
SELECT name, monthlymaintenance,
	CASE WHEN monthlymaintenance > 100 THEN 'epensive' WHEN monthlymaintenance <= 100 THEN 'cheap' END AS price
FROM Facilities
